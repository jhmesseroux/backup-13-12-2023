...
const FavouriteVerses = ({ navigation }) => {
  ...
  const { data, isError, isLoading, error, isFetching, refetch } = useFavouriteVerses(TYPE.FAVOURITE);
        ...
        <View className='mt-6 mb-6'>
          {data?.data.length > 0 ? (
            ...
            <View
              ...
              <Text className='text-lg text-slate-700 mb-4'>Tu n'as pas de favoris </Text>
              <LinearGradient
...
export default FavouriteVerses;
